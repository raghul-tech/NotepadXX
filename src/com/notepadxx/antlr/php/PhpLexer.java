...
public class PhpLexer extends PhpLexerBase {
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		switch (ruleIndex) {
		case 5:
			HtmlScriptOpen_action(_localctx, actionIndex);
			break;
		case 6:
			HtmlStyleOpen_action(_localctx, actionIndex);
			break;
		case 18:
			HtmlClose_action(_localctx, actionIndex);
			break;
		case 224:
			CloseCurlyBracket_action(_localctx, actionIndex);
			break;
		case 246:
			CurlyDollar_action(_localctx, actionIndex);
			break;
		}
	}
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 10:
			return Shebang_sempred(_localctx, predIndex);
		case 45:
			return PHPEnd_sempred(_localctx, predIndex);
		case 241:
			return StartNowDoc_sempred(_localctx, predIndex);
		case 242:
			return StartHereDoc_sempred(_localctx, predIndex);
		case 246:
			return CurlyDollar_sempred(_localctx, predIndex);
		case 257:
			return PhpStartEchoFragment_sempred(_localctx, predIndex);
		case 258:
			return PhpStartFragment_sempred(_localctx, predIndex);
		}
		return true;
	}
