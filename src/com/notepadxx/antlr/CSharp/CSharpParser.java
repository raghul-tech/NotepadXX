package com.notepadxx.antlr.CSharp;
...
// Generated from C#/CSharpParser.g4 by ANTLR 4.13.2
...
public class CSharpParser extends CSharpParserBase {
	...
	public final Right_arrowContext right_arrow() throws RecognitionException {
		...
		try {
			...
			setState(2352);
			if (!((_localctx.first!=null?_localctx.first.getTokenIndex():0) + 1 == (_localctx.second!=null?_localctx.second.getTokenIndex():0))) {
	...
	private boolean right_arrow_sempred(Right_arrowContext _localctx, int predIndex) {
		switch (predIndex) {
		case 1:
			return (_localctx.first!=null?_localctx.first.getTokenIndex():0) + 1 == (_localctx.second!=null?_localctx.second.getTokenIndex():0);
		}
		return true;
	}
