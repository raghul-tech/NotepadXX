...
import com.notepadxx.antlr.kotlin.KotlinLexer;
import com.notepadxx.antlr.kotlin.KotlinParser;
...
public class kotlinChecker {
	 ...
	 private Texteditor editor;
	    ...
	    public kotlinChecker(Texteditor editor) {
	        this.editor = editor;
	    ...
	    private void checkAgain() {
	    	...
	    	//	 StringBuilder currentCode = new StringBuilder(editor.getTextContent());
	            // String currentCode = editor.getTextArea().getText();
	             kotlinSyntax(editor.getTextContent()); // Recheck syntax in updated mode
	         });
	    }
	    protected void kotlinSyntax(String code) {
	        SwingWorker<List<syntaxError>, Void> worker = new SwingWorker<>() {
	            ...
	            protected void done() {
	                try {
	                    ...
	                    SwingUtilities.invokeLater(() -> {
	                        String errorMessage = hightlight.ErrorForCode1(syntaxErrors, editor, advancedMode, tooltip,"Kotlin");
