...
import com.notepadxx.antlr.python3_13_2.PythonLexer;
import com.notepadxx.antlr.python3_13_2.PythonParser;
...
public class PythonChecker {
	 ...
	 private Texteditor editor;
	    ...
	    public PythonChecker(Texteditor editor) {
	        this.editor = editor;
	    ...
	    private void checkAgain() {
	    	 SwingUtilities.invokeLater(() -> {
	            ...
	            // String currentCode = editor.getTextArea().getText();
	             PythonSyntax(editor.getTextContent()); // Recheck syntax in updated mode
	         });
	    }

	    protected void PythonSyntax(String code) {
