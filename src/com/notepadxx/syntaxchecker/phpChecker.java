...
import com.notepadxx.antlr.php.PhpLexer;
import com.notepadxx.antlr.php.PhpParser;
import com.notepadxx.notepadxx.Texteditor;

public class phpChecker {
	 ...
	 private Texteditor editor;
	    ...
	    public phpChecker(Texteditor editor) {
	        this.editor = editor;
	    ...
	    private void checkAgain() {
	    	 SwingUtilities.invokeLater(() -> {
	    		// StringBuilder currentCode = new StringBuilder(editor.getTextContent());
	             ...
	             phpSyntax(editor.getTextContent()); // Recheck syntax in updated mode
	         });
	    }
	    protected void phpSyntax(String code) {
	        SwingWorker<List<syntaxError>, Void> worker = new SwingWorker<>() {
	            ...
	            protected void done() {
	                try {
	                    ...
	                    SwingUtilities.invokeLater(() -> {
	                        String errorMessage = hightlight.ErrorForCode1(syntaxErrors, editor, advancedMode, tooltip,"PHP");
