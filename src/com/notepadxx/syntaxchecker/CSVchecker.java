...
import com.notepadxx.antlr.CSV.CSVLexer;
import com.notepadxx.antlr.CSV.CSVParser;
...
public class CSVchecker {
	 ...
	 private Texteditor editor;
	    ...
	    public CSVchecker(Texteditor editor) {
	        this.editor = editor;
	    ...
	    private void checkAgain() {
	    	 SwingUtilities.invokeLater(() -> {
	    		// StringBuilder currentCode = new StringBuilder(editor.getTextContent());
	             ...
	             CSVSyntax(editor.getTextContent()); // Recheck syntax in updated mode
	         });
	    }
    protected  void CSVSyntax(String code) {
            ...
            protected void done() {
                try {
                   ...
                   // SwingUtilities.invokeLater(() -> editor.getTextArea().getHighlighter().removeAllHighlights());
                    ...
                    SwingUtilities.invokeLater(() -> {
                        String errorMessage = hightlight.ErrorForCode1(syntaxErrors, editor, advancedMode, tooltip,"CSV");
