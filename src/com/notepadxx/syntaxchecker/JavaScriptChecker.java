...
import com.notepadxx.antlr.javascript.JavaScriptLexer;
import com.notepadxx.antlr.javascript.JavaScriptParser;
...
public class JavaScriptChecker {
	 ...
	 private Texteditor editor;
	    ...
	    public JavaScriptChecker(Texteditor editor) {
	        this.editor = editor;
	    ...
	    private void checkAgain() {
	    	 SwingUtilities.invokeLater(() -> {
	    		// StringBuilder currentCode = new StringBuilder(editor.getTextContent());
	             ...
	             JavaScriptSyntax(editor.getTextContent()); // Recheck syntax in updated mode
	         });
	    }

	    protected void JavaScriptSyntax(String code) {
	        SwingWorker<List<syntaxError>, Void> worker = new SwingWorker<>() {
	            ...
	            protected void done() {
	                try {
	                    ...
	                    SwingUtilities.invokeLater(() -> {
	                        String errorMessage = hightlight.ErrorForCode1(syntaxErrors, editor, advancedMode, tooltip,"JavaScript");
