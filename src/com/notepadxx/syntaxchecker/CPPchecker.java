...
import com.notepadxx.antlr.CPP.CPP14Lexer;
import com.notepadxx.antlr.CPP.CPP14Parser;
...
public class CPPchecker {
	 ...
	 private Texteditor editor;
	    ...
	    public CPPchecker(Texteditor editor) {
	        this.editor = editor;
	    ...
	    private void checkAgain() {
	    	...
	    	//	 StringBuilder currentCode = new StringBuilder(editor.getTextContent());
	            // String currentCode = editor.getTextArea().getText();
	             CPPSyntax(editor.getTextContent()); // Recheck syntax in updated mode
	         });
	    }
    protected void CPPSyntax(String code) {
	            ...
	            protected void done() {
	                try {
	                   ...
	                   // SwingUtilities.invokeLater(() -> editor.getTextArea().getHighlighter().removeAllHighlights());
	                    ...
	                    SwingUtilities.invokeLater(() -> {
	                        String errorMessage = hightlight.ErrorForCode1(syntaxErrors, editor, advancedMode, tooltip,"C++");
