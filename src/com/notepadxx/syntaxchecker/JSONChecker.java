...
import com.notepadxx.antlr.json.JSONLexer;
import com.notepadxx.antlr.json.JSONParser;
...
public class JSONChecker {
	 private Texteditor editor;
	    ...
	    public JSONChecker(Texteditor editor) {
	        this.editor = editor;
	    ...
	    private void checkAgain() {
	    	 SwingUtilities.invokeLater(() -> {
	    		// StringBuilder currentCode = new StringBuilder(editor.getTextContent());
	             ...
	             JSONSyntax(editor.getTextContent()); // Recheck syntax in updated mode
	         });
	    }

	    protected void JSONSyntax(String code) {
	        SwingWorker<List<syntaxError>, Void> worker = new SwingWorker<>() {
	            ...
	            protected void done() {
	                try {
	                    ...
	                    SwingUtilities.invokeLater(() -> {
	                        String errorMessage = hightlight.ErrorForCode1(syntaxErrors, editor, advancedMode, tooltip,"JSON");
