...
import com.notepadxx.antlr.C.CLexer;
import com.notepadxx.antlr.C.CParser;
...
public class Cchecker {
    ...
    public Cchecker(Texteditor editor) {
        this.editor = editor;
    ...
    private void checkAgain() {
    	 SwingUtilities.invokeLater(() -> {
    		// StringBuilder currentCode = new StringBuilder(editor.getTextContent());
             ...
             CSyntax(editor.getTextContent()); // Recheck syntax in updated mode
         });
    }


    protected void CSyntax(String code) {
