...
import com.notepadxx.antlr.dart.Dart2Lexer;
import com.notepadxx.antlr.dart.Dart2Parser;
import com.notepadxx.notepadxx.Texteditor;

public class dartChecker {
	 ...
	 private Texteditor editor;
	    ...
	    public dartChecker(Texteditor editor) {
	        this.editor = editor;
	    ...
	    private void checkAgain() {
	    	...
	    	//	 StringBuilder currentCode = new StringBuilder(editor.getTextContent());
	            // String currentCode = editor.getTextArea().getText();
	             dartSyntax(editor.getTextContent()); // Recheck syntax in updated mode
	         });
	    }
    protected void dartSyntax(String code) {
            ...
            protected void done() {
                try {
                   ...
                   // SwingUtilities.invokeLater(() -> editor.getTextArea().getHighlighter().removeAllHighlights());
                    ...
                    SwingUtilities.invokeLater(() -> {
                        String errorMessage = hightlight.ErrorForCode1(syntaxErrors, editor, advancedMode, tooltip,"Dart");
