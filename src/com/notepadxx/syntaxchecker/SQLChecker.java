...
import com.notepadxx.antlr.sql.MySQLLexer;
import com.notepadxx.antlr.sql.MySQLParser;
...
public class SQLChecker {
	 ...
	 private Texteditor editor;
	    ...
	    public SQLChecker(Texteditor editor) {
	        this.editor = editor;
	    ...
	    private void checkAgain() {
	    	...
	    	//	 StringBuilder currentCode = new StringBuilder(editor.getTextContent());
	            // String currentCode = editor.getTextArea().getText();
	             SQLSyntax(editor.getTextContent()); // Recheck syntax in updated mode
	         });
	    }
	    protected void SQLSyntax(String code) {
	        SwingWorker<List<syntaxError>, Void> worker = new SwingWorker<>() {
	            ...
	            protected void done() {
	                try {
	                    ...
	                    SwingUtilities.invokeLater(() -> {
	                        String errorMessage = hightlight.ErrorForCode1(syntaxErrors, editor, advancedMode, tooltip,"SQL");
