...
import com.notepadxx.antlr.html.HTMLLexer;
import com.notepadxx.antlr.html.HTMLParser;
...
public class HTMLChecker {
	 ...
	 private Texteditor editor;
	    ...
	    public HTMLChecker(Texteditor editor) {
	        this.editor = editor;
	    ...
	    private void checkAgain() {
	    	 SwingUtilities.invokeLater(() -> {
	            ...
	            // String currentCode = editor.getTextArea().getText();
	             HTMLSyntax(editor.getTextContent()); // Recheck syntax in updated mode
	             //updateUI();
	         });
	    }
	    

	    protected void HTMLSyntax(String code) {
	        SwingWorker<List<syntaxError>, Void> worker = new SwingWorker<>() {
	            ...
	            protected void done() {
	                try {
	                    ...
	                    SwingUtilities.invokeLater(() -> {
	                        String errorMessage = hightlight.ErrorForCode1(syntaxErrors, editor, advancedMode, tooltip,"HTML");
